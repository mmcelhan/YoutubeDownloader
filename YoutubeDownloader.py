...
class YTDownloader(QtWidgets.QWidget):

    def __init__(self):
        super().__init__()
        self.download_type = 'Video'
        self.download_directory = str(os.path.join(os.getcwd(), 'downloads'))
        self.youtube_link = ''
        ...
        self.download_button = QtWidgets.QPushButton("Press to Download", self)
    ...
    def init_ui(self):
        ...
        self.folder_text.setText(str(self.download_directory))
    ...
    def show_folder_dialog(self):
        ...
        if ok:
            ...
            self.download_directory = str(text)
    ...
    def get_directory(self):
        folder_name = self.download_directory
    ...
    def youtube_dl(self):
        ...
        hlp.youtube_dl(self.download_directory, self.download_type, self.youtube_link)
